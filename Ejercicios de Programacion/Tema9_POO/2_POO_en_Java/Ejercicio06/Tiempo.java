...
public class Tiempo {
 ...
 //METODOS ESPECIFICOS//////////////////////////////////////////////////////////
  ...
  /**
   * Resta dos intervalos de tiempo, t1.resta(t2), tanto t1 como t2 son objetos que
   * tienen 3 numeros (las variables de horas,minutos y segundos). Asi que restamos
   * cada una con su respectivo destino y luego lo pasamos por un filtro (bucles while)
   * para reasignar bien la distribucion de horas/minutos/segundos sin que
   * sobrepasen la cifra 60.
