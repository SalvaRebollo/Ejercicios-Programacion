...
//SETTERS
  ...
  /**
   * //SOBRECARGA
   * Multiplica fraccion por fraccion a.multiplica(f)
   * @param fraccion
   * @return Nueva fraccion multiplicada por numero entero
   */
  ...
  /**
   * //SOBRECARGA
   * Divide fraccion entre fraccion a.divide(f)
  ...
  /**
   * Simplifica una fraccion hasta ser irreducible, si ya es irreducible desvuelve
   * la misma fraccion introducida.
   * @return Simplifica una fraccion hasta ser irreducible, si ya es irreducible desvuelve
   * la misma fraccion introducida.
   */
